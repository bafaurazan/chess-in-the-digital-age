...
choose_max_date_to_scrap_game_count = function(date = "2024-04"){
...
games_count = choose_max_date_to_scrap_game_count()
head(games_count)
...
```{r eval=FALSE}
preparing_month_dataset("2024-02")

removing_oryginal_dataset("2024-02")
```
